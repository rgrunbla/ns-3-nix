...
public:
    ...
    /* Received transmission powers from neighbours */
...
public:
    ...
    void DevMonitorSnifferRx(std::string, Ptr<const Packet>, uint16_t,
                             WifiTxVector, struct MpduInfo,
                             struct SignalNoiseDbm, uint16_t staId);
    ...
    void configureMobility(Ptr<ListPositionAllocator>, Ptr<UniformRandomVariable>);
    void configureWifi(bool, int, int, bool, std::string);
